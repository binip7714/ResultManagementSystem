...
<center><img src="hcoe.png" width="100" height="100">
<img src="himal.PNG" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Department Name</label>
                                    <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="success.php" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Advanced Java</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Network Programming</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Mobile Progranmming</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Distributed System</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Applied Economics</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Project II</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        <tr>
          ...
          <td>HCOE076BCA03</td>
          <td>Binip Ghimire</td>
          <td>Phanindra Prasad Ghimire</td>
          <td>Male</td>
        </tr>
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact HCOE Teams.
Designed & Developed by BCA Teams</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ HCOE</h5></center> 
  <hr class="new1">
<br>
</body>
</html>